...
def userprofile(username):
    ...
    next_url = url_for('main.userprofile', username=user.username, page=posts.next_num) \
        if posts.has_next else None
    prev_url = url_for('main.userprofile', username=user.username, page=posts.prev_num) \
        if posts.has_prev else None
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('main.userprofile', username=current_user.username))
...
def follow(username):
    ...
    return redirect(url_for('main.userprofile', username=username))
